package ma.atos.billing.customer.billing_customer.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/customers/**").hasAnyRole("admin", "agent_facturation", "agent_paiement", "lecteur")
