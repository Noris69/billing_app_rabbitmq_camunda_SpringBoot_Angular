...
public class RabbitMqConfig {
    ...
    @Bean
    public Queue paymentRequestedDeadLetterQueue(@Value("${billing.rabbitmq.payment-requested-dlq}") String queue) {
        return new Queue(queue, true);
    }
    ...
    @Bean
    public Binding paymentRequestedDeadLetterBinding(
            Queue paymentRequestedDeadLetterQueue,
            DirectExchange billingDeadLetterExchange,
            @Value("${billing.rabbitmq.payment-requested-dlq-routing-key}") String routingKey
    ) {
        return BindingBuilder.bind(paymentRequestedDeadLetterQueue).to(billingDeadLetterExchange).with(routingKey);
    }
    ...
    public SimpleRabbitListenerContainerFactory rabbitListenerContainerFactory(
            ...
            @Value("${billing.rabbitmq.payment-requested-dlq-routing-key}") String deadLetterRoutingKey
    ) {
